...
namespace WindowsFormsApp1
{
    ...
    public partial class DateTimeChoser : UserControl
    {
        ...
        /// </summary>    
        public static void AddTo(TextBox textBoox, string dateTime)
        {
            textBoox.Text = dateTime;
        ...
        private void init()
        {
            ...
            comboBox_minute.Items.Clear();
            comboBox_second.Items.Clear();

            if (StaticPatient.anesthesiaData.Thebeginningofsurgery.Date == DateTime.Now.Date)
            {
                for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Hour;
                            i <= DateTime.Now.Hour; i++) comboBox_hour.Items.Add((i < 10 ? "0" : "") + i);

                if (StaticPatient.anesthesiaData.Thebeginningofsurgery.Hour == DateTime.Now.Hour)
                {
                    for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Minute;
                        i <= DateTime.Now.Minute; i = i + 1) comboBox_minute.Items.Add((i < 10 ? "0" : "") + i);

                    if (StaticPatient.anesthesiaData.Thebeginningofsurgery.Minute == DateTime.Now.Minute)
                        for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Second;
                            i <= DateTime.Now.Second; i++) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                }
            }
            else
                for (int i = 0; i <= DateTime.Now.Hour; i++) comboBox_hour.Items.Add((i < 10 ? "0" : "") + i);

            if (comboBox_minute.Items.Count == 0)
                for (int i = 0; i <= DateTime.Now.Minute; i = i + 1) comboBox_minute.Items.Add((i < 10 ? "0" : "") + i);
            if (comboBox_second.Items.Count == 0)
                for (int i = 0; i <= DateTime.Now.Second; i++) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
            ...
            monthCalendar1.MinDate = StaticPatient.anesthesiaData.Thebeginningofsurgery;
        }
        ...
        private void monthCalendar1_DateSelected(object sender, DateRangeEventArgs e)
        {
            ...
            {
                comboBox_hour.Items.Clear();
                if (S.Date.Equals(StaticPatient.anesthesiaData.Thebeginningofsurgery.Date))
                {
                    for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Hour;
                            i < 24; i++) comboBox_hour.Items.Add((i < 10 ? "0" : "") + i);
                    if ((int)comboBox_minute.Text[0] * 10 + (int)comboBox_minute.Text[1] < StaticPatient.anesthesiaData.Thebeginningofsurgery.Minute)
                    {
                        comboBox_minute.Items.Clear();
                        comboBox_second.Items.Clear();
                        for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Minute;
                            i < 60; i = i + 1) comboBox_minute.Items.Add((i < 10 ? "0" : "") + i);
                        for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Second;
                            i < 60; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                        setDateTime(StaticPatient.anesthesiaData.Thebeginningofsurgery);
                    }
                }
                else if (S.Date.Equals(DateTime.Now.Date))
                {
                    comboBox_hour.Items.Clear();
                    for (int i = 0; i <= DateTime.Now.Hour; i++) comboBox_hour.Items.Add((i < 10 ? "0" : "") + i);
                    if ((int)comboBox_minute.Text[0] * 10 + (int)comboBox_minute.Text[1] > DateTime.Now.Minute)
                    {
                        comboBox_minute.Items.Clear();
                        comboBox_second.Items.Clear();
                        for (int i = 0; i < DateTime.Now.Minute; i = i + 1) comboBox_minute.Items.Add((i < 10 ? "0" : "") + i);
                        for (int i = 0; i < DateTime.Now.Second; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                        setDateTime(DateTime.Now);
                    }
                }
                else
                {
                    ...
                    for (int i = 0; i < 60; i = i + 1) comboBox_minute.Items.Add((i < 10 ? "0" : "") + i);
                    for (int i = 0; i < 60; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                }
            }
        }
        ...
        {
            string time = comboBox_hour.Text + ":" + comboBox_minute.Text + ":" + comboBox_second.Text;
            ...
            /*
            comboBox_minite.Items.Clear();
            comboBox_second.Items.Clear();
            if (comboBox_hour.Text[0]*10+ comboBox_hour.Text[1] == StaticPatient.anesthesiaData.Thebeginningofsurgery.Hour 
                && monthCalendar1.SelectionStart.Date == StaticPatient.anesthesiaData.Thebeginningofsurgery.Date)
            {
                for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Minute;
                    i < 60; i = i + 1) comboBox_minite.Items.Add((i < 10 ? "0" : "") + i);
                for (int i = StaticPatient.anesthesiaData.Thebeginningofsurgery.Second;
                    i < 60; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                setDateTime(StaticPatient.anesthesiaData.Thebeginningofsurgery);
            }
            else if(comboBox_hour.Text[0] * 10 + comboBox_hour.Text[1] == DateTime.Now.Hour
                && monthCalendar1.SelectionStart.Date == DateTime.Now.Date)
            {
                for (int i = 0; i < DateTime.Now.Minute; i = i + 1) comboBox_minite.Items.Add((i < 10 ? "0" : "") + i);
                for (int i = 0; i < DateTime.Now.Second; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                setDateTime(DateTime.Now);
            }
            else
            {
                ...
                for (int i = 0; i < 60; i = i + 1) comboBox_second.Items.Add((i < 10 ? "0" : "") + i);
                setDateTime(DateTime.Parse(time));
            }*/
        }
        ...
        public void setDateTime(DateTime now)
        {
            ...
            comboBox_hour.SelectedIndex = comboBox_hour.FindStringExact(now.Hour/10+""+ now.Hour%10);
            comboBox_minute.SelectedIndex = comboBox_minute.FindStringExact(now.Minute / 10 + "" + now.Minute % 10); 
            comboBox_second.SelectedIndex = comboBox_second.FindStringExact(now.Second / 10 + "" + now.Second % 10); 
        }
